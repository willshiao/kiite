...
# Train baselines
for k in range(3):
    baseline_run('news_clean', 'logistic_regression', 'bert')
    baseline_run('news_clean', 'random_forest', 'bert')
    baseline_run('news_clean', 'logistic_regression', 'fasttext')
    baseline_run('news_clean', 'random_forest', 'fasttext')

    baseline_run('news_vaccine', 'logistic_regression', 'bert')
    baseline_run('news_vaccine', 'random_forest', 'bert')
    baseline_run('news_vaccine', 'logistic_regression', 'fasttext')
    baseline_run('news_vaccine', 'random_forest', 'fasttext')

    baseline_run('news_transmission', 'logistic_regression', 'bert')
    baseline_run('news_transmission', 'random_forest', 'bert')
    baseline_run('news_transmission', 'logistic_regression', 'fasttext')
    baseline_run('news_transmission', 'random_forest', 'fasttext')


TARGET = [10, 100, 1000, 5000, 10000]
for k in range(3):
    for num_cord in TARGET:
        cord_run('news_clean', 'logistic_regression', 'bert', num_cord)
        cord_run('news_clean', 'random_forest', 'bert', num_cord)
        cord_run('news_clean', 'logistic_regression', 'fasttext', num_cord)
        cord_run('news_clean', 'random_forest', 'fasttext', num_cord), num_cord

        cord_run('news_vaccine', 'logistic_regression', 'bert', num_cord)
        cord_run('news_vaccine', 'random_forest', 'bert', num_cord)
        cord_run('news_vaccine', 'logistic_regression', 'fasttext', num_cord)
        cord_run('news_vaccine', 'random_forest', 'fasttext', num_cord), num_cord

        cord_run('news_transmission', 'logistic_regression', 'bert', num_cord)
        cord_run('news_transmission', 'random_forest', 'bert', num_cord)
        cord_run('news_transmission', 'logistic_regression', 'fasttext', num_cord)
        cord_run('news_transmission', 'random_forest', 'fasttext', num_cord)
